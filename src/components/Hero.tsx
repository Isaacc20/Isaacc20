    ...
    return (
        <>
            {/* <div id='' className="h-screen"> */}
                <div className="relative hero flex flex-col gap-24 justify-center items-center p-20">
                    ...
                    <div className="w-full flex flex-col gap-10 bg-gradient-to-tr from-blue-400 to-green-400 bg-clip-text">
                        <span className='text-slate-100 text-7xl md:text-8xl text-start'>Building <span className="text-transparent">scalable</span>, <span className="text-transparent">impact led</span> and <span className="text-transparent">redemptive</span> solutions</span>
