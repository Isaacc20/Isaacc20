...
const Resume = () => (
    <>
        <div className="flex flex-col items-start gap-10  md:p-10 lg:p-20 py-12 mx-auto">
            <div className="flex items-center justify-start w-full">
                <span className="flex items-center gap-3 md:gap-5 px-5 py-2 rounded-full border border-slate-100 text-slate-100 font-thin"><BsCodeSlash /> MY EXPERIENCE</span>
            </div>
            ...
            <div className="flex flex-col items-start gap-10">
                ...
                <div className="flex flex-col gap-3 md:gap-5">
                    ...
                    <div className="pl-9 flex flex-col gap-3">
                        ...
                        Managed the frontend for Gamr’s web products, including Brackets, a tournament management platform.
                        </span>
                ...
                <div className="flex flex-col gap-3 md:gap-5">
                    ...
                    <div className="pl-9 flex flex-col gap-3">
                        <Link to={'https://actssocial.com'} className="text-white text-2xl">ActsSocial - <span className="text-lg italic">Front-end Engineer</span></Link>
                        <span className="text-gray-400">
