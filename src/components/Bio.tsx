...
const Bio: FC = () => {
    return (
        <>
            <div className="sticky top-5 bg-gradient-to-tr from-blue-400 to-green-400 rounded-[30px] w-1/3 min-w-80 h-full p-[1px] overflow-hidden">
                <div className=" bg-[#1E1E1E] flex flex-col items-center rounded-[30.5px] gap-10 px-10 py-6">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <span className="font-light text-3xl text-slate-100 text-center">Isaac Oyedele</span>
                    </div>
                    ...
                    <button className="bg-cyan-400 w-full p-3 text-lg flex gap-3 items-center justify-center rounded-xl"><FiMail /> HIRE ME</button>
                </div>
            </div>
        </>
    )
